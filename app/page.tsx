  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#edf8fc] text-slate-950">
      ...
      <header className="sticky top-0 z-50 px-4 pt-4 sm:px-6">
        <nav className="mx-auto flex h-[70px] max-w-6xl items-center justify-between rounded-full border border-white/90 bg-white/95 px-5 shadow-[0_14px_45px_rgba(15,23,42,.08)] backdrop-blur-xl sm:px-7">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <Link
              ...
              className="rounded-full bg-sky-500 px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-sky-500/20 transition duration-300 hover:-translate-y-0.5 hover:bg-sky-600 sm:px-5"
            >
              Registrieren
            </Link>
          </div>
