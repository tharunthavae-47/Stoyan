  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#edf8fc] text-slate-950">
      ...
      <header className="sticky top-0 z-50 px-4 pt-4 sm:px-6">
        <nav className="mx-auto flex h-[68px] max-w-6xl items-center justify-between rounded-full border border-white/90 bg-white/90 px-5 shadow-[0_14px_45px_rgba(15,23,42,.08)] backdrop-blur-xl sm:px-7">
