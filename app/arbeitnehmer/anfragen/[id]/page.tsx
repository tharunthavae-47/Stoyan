  ...
  return (
    <div className="animate-fade-up"><div className="mx-auto max-w-5xl">
      ...
      {request.status === "accepted" && <section className="mt-7 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 bg-[var(--navy)] px-6 py-5 text-white"><p className="text-xs font-black uppercase tracking-widest text-blue-300">Privater Chat</p><h2 className="mt-1 text-xl font-black">{companyName}</h2><p className="mt-1 text-sm text-blue-100/80">Arbeitgeber links · Arbeitnehmer rechts</p></div>
